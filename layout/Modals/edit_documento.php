<!-- Editar -->
<div class="modal fade" id="documento_editor" tabindex="-1" role="dialog" 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input id="archivoE" name="archivoE" type="file" class="form-control">
        </div>
      </div>
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" 
        	data-dismiss="modal" onclick="Documento.editar()">Guardar</button>
      </div>
    </div>
  </div>
</div>
